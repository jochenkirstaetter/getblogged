...
image: content/images/2019/01/SteelSeries_Keyboard_GreenBacklit.jpg
...
imageUrl: https://jochen.kirstaetter.name/content/images/2019/01/SteelSeries_Keyboard_GreenBacklit.jpg
...
tagName: ''
tagDescription: ''
featureImage: content/images/2019/01/SteelSeries_Keyboard_GreenBacklit.jpg
featured: false
...
![Use a shortcut combination to launch PowerShell in current folder](../content/images/2019/01/Windows10PowershellAltFR.png)
...
![Simply type `powershell` into the address bar and hit `Enter`](../content/images/2019/01/Windows10PowershellAddressbar.png)
...
![Left: Regular context menu - Right: Extended context menu](../content/images/2019/01/Windows10FolderContextRegular.png)
...
![Access PowerShell in context menu: Remove or rename the `Extended` key](../content/images/2019/01/Windows10FolderContextRegistry-1.png)
...
![Use Windows PowerShell instead of Command Prompt](../content/images/2019/01/Windows10TaskbarPowershell.png)
...
![Launch Windows PowerShell quickly from the Start menu](../content/images/2019/01/Windows10PowershellStart.png)<small>Image credit: Jochen Kirstätter</small>
