...
status: published
type: post
description: Open Data has been initiated in Mauritius back in 2012, it is only this year that there seems to be more momentum towards an Open Data initiative.
tags:
- General
keywords: General
...
excerpt: Although Open Data is around since several years in other countries and has been initiated in Mauritius already back in 2012, it is only this year that there seems to be more momentum towards an Open...
twitterTitle: Mauritius Open Data Readiness Assessment (ODRA)
twitterDescription: Although Open Data is around since several years in other countries and has been initiated in Mauritius already back in 2012, it is only this year that there seems to be more momentum towards an Open...
twitterImage: 
facebookTitle: Mauritius Open Data Readiness Assessment (ODRA)
facebookDescription: Although Open Data is around since several years in other countries and has been initiated in Mauritius already back in 2012, it is only this year that there seems to be more momentum towards an Open...
facebookImage: ''
codeinjectionHead: 
codeinjectionFoot: 
---
...
![Attendees of various IT user groups and communities in Mauritius at the workshop with the World Bank on Open Data in Mauritius](https://s.kirstaetter.name/images/odra_workshop_attendees.png "Attendees of various IT user groups and communities in Mauritius at the workshop with the World Bank on Open Data in Mauritius")  
...
![Delegation of the World Bank during the workshop with local IT user groups](https://s.kirstaetter.name/images/odra_workshop_worldbank.png "Delegation of the World Bank during the workshop with local IT user groups")  
...
> *"I started with the preparations of the Developers Conference 2016 - [https://2016.mscc.mu/](https://2016.mscc.mu/) - recently, and I'd like to see whether it would be possible to have access to any datasets of Open Data in April/May next year in order to schedule a hackathon or app challenge during the conference days."*
...
![Datasets that could be made open data quickly by the government of Mauritius](https://s.kirstaetter.name/images/odra_findings_quickdatasets.png "Datasets that could be made open data quickly by the government of Mauritius")  
...
![The Open Data Readiness Assessment differentiates between access to information and access to Open Data](https://s.kirstaetter.name/images/odra_findings_access.png "The Open Data Readiness Assessment differentiates between access to information and access to Open Data")  
