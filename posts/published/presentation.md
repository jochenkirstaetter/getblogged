...
excerpt: <!--   --> Sessions Mauritius Software Craftsmanship Community (MSCC) 11.2013 Linuxfest 2013 Running Windows applications on Linux - Taking into consideration that the End of Support Lifecycle for...
twitterTitle: Presentations
twitterDescription: <!--   --> Sessions Mauritius Software Craftsmanship Community (MSCC) 11.2013 Linuxfest 2013 Running Windows applications on Linux - Taking into consideration that the End of Support Lifecycle for...
twitterImage: 
facebookTitle: Presentations
facebookDescription: <!--   --> Sessions Mauritius Software Craftsmanship Community (MSCC) 11.2013 Linuxfest 2013 Running Windows applications on Linux - Taking into consideration that the End of Support Lifecycle for...
facebookImage: ''
codeinjectionHead: 
codeinjectionFoot: 
---
...
11.2013 [Infotech 2013](https://www.infotech.mu/info13/home.asp)

Running Windows applications on Linux - Taking into consideration that the End of Support Lifecycle for Microsoft Windows XP is closing in one might be confronted with the question whether it would be possible to keep existing hardware and installed software applications without having the necessity to upgrade the operating system (which eventually might be incompatible or requires higher investment). The session provides a brief overview of potential solutions and demonstrates quickly how to install and run Windows software on Linux.

#### [Microsoft Visual FoxPro Entwicklerkonferenz - Developer conference](https://devcon.dfpug.de/)
...
09.2006 [Zeitmanagement mit Microsoft Office Outlook](https://www.amazon.de/exec/obidos/ASIN/3860635832/afpwiki-21)

Wer dem Chaos auf seinem Schreibtisch Herr werden möchte, ist mit diesem Buch bestens beraten.

09.2006 [Arbeiten mit dem Visual Studio 2005 Team System](https://www.amazon.de/exec/obidos/ASIN/3860639838/afpwiki-21)
...
07.2005 [Pragmatic Version Control Using Subversion](https://www.amazon.de/exec/obidos/ASIN/0974514063/afpwiki-21)
...
07.2005 [Introducing Microsoft SQL Server 2005 For Developers](https://www.amazon.de/exec/obidos/ASIN/073561962X/afpwiki-21)
...
04.2005 [.NET for Visual FoxPro Developers](https://www.amazon.de/exec/obidos/ASIN/1930919301/afpwiki-21)
...
05.2005 [MSDN: Visual FoxPro mit Visual Studio 2005](https://www.microsoft.com/germany/MSDN/webcasts/library.aspx?id=118758879 "MSDN: Visual FoxPro mit Visual Studio 2005")
