...
image: content/images/2020/05/tai-s-captures-LS_o7wNTNAk-unsplash.jpg
...
imageUrl: https://jochen.kirstaetter.name/content/images/2020/05/tai-s-captures-LS_o7wNTNAk-unsplash.jpg
...
tagName: ''
tagDescription: ''
featureImage: content/images/2020/05/tai-s-captures-LS_o7wNTNAk-unsplash.jpg
featured: false
...
![Krisp.ai running in the Windows systray and ready to use](../content/images/2020/05/image-4.png)
...
![Not having an NVIDIA RTX GPU should stop us here](../content/images/2020/05/image-5.png)
...
![Adjust permissions of RTXVoice.nvi file](../content/images/2020/05/image-6.png)

Confirm all dialogs and then open the file `RTXVoice.nvi` with your favourite text editor.

![Delete the constraints section from the file](../content/images/2020/05/image-7.png)
...
![Running NVIDIA RTX Voice on a GeForce GTX 1060 GPU](../content/images/2020/05/image-9.png)
...
![Configuring Microsoft Teams to use NVIDIA RTX Voice devices](../content/images/2020/05/image-11.png)
