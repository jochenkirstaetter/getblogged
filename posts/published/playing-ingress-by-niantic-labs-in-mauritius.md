...
status: published
type: post
description: Playing Ingress by Niantic Labs is still a tough challenge on Mauritius. Hopefully, this article will increase awareness and recruit more agents.
tags:
- Android
keywords: Android
...
excerpt: As of writing this article it is quite tough to play Ingress here in Mauritius. Unfortunately, it seems that there is only a low awareness of this great Android app by Niantic Labs.
twitterTitle: Playing Ingress by Niantic Labs in Mauritius
twitterDescription: As of writing this article it is quite tough to play Ingress here in Mauritius. Unfortunately, it seems that there is only a low awareness of this great Android app by Niantic Labs.
twitterImage: 
facebookTitle: Playing Ingress by Niantic Labs in Mauritius
facebookDescription: As of writing this article it is quite tough to play Ingress here in Mauritius. Unfortunately, it seems that there is only a low awareness of this great Android app by Niantic Labs.
facebookImage: ''
codeinjectionHead: 
codeinjectionFoot: 
---
...
- the [official Google+ page of Ingress](https://plus.google.com/+Ingress "official Google+ page of Ingress") (nice vanity URL),
- the [support information on Ingress Scanner Technology](https://support.google.com/ingress/ "support information on Ingress Scanner Technology") (IMHO, best resource),  
- the [Ingress Community](https://plus.google.com/communities/103803967875500436831 "Ingress Community") and  
- the [official YouTube channel of Ingress](https://www.youtube.com/user/ingress?feature=watch "official YouTube channel of Ingress")
...
[![Ingress Portals in Port Louis, Mauritius](https://s.kirstaetter.name/images/ingress_portals_portlouis.png "Ingress Portals in Port Louis, Mauritius")  
](https://www.ingress.com/intel?ll=-20.162808,57.501846&z=17 "Click to see the current status in Port Louis (only for agents)")*Intel map of Ingress portals in Port Louis*[](https://www.ingress.com/intel?ll=-20.162808,57.501846&z=17 "Click to see the current status in Port Louis (only for agents)")
...
![Building links and control fields in Ingress to gain action points](https://s.kirstaetter.name/images/ingress_controlfield.png "Building links and control fields in Ingress to gain action points") ![By the time there will be more links and control fields](https://s.kirstaetter.name/images/ingress_controlfield_followup.png "By the time there will be more links and control fields")  
...
![Building high level Ingress portals is pure team-work!](https://s.kirstaetter.name/images/ingress_portal_details.png "Building high level Ingress portals is pure team-work!")  
...
Some days ago, and also notified in Google+ by agent Stumpsand, I came across a great article by Tim Bray on [Advanced Ingress](https://www.tbray.org/ongoing/When/201x/2013/04/21/Advanced-Ingress "Advanced Ingress") techniques. Also have a look at the other resources in his series: [Ingress](https://www.tbray.org/ongoing/When/201x/2012/12/08/Ingress "Ingress"), [Things About Ingress](https://www.tbray.org/ongoing/When/201x/2013/01/09/Things-about-Ingress "Things About Ingress"), [Ingress, Month 3](https://www.tbray.org/ongoing/When/201x/2013/01/29/Ingress-Month-3 "Ingress, Month 3"), [Ingress Weekly](https://www.tbray.org/ongoing/When/201x/2013/02/06/Improving-Ingress "Ingress Weekly"), and [Ingress Tourism](https://www.tbray.org/ongoing/When/201x/2013/03/30/Ingress "Ingress Tourism").