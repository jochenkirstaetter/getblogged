...
status: published
type: post
description: Intranet Explorer - Ja, das erscheint mir aktuell als wesentlich passenderen Namen für den Microsoft IE.
tags:
- General
keywords: General
metaTitle: Intranet Explorer
metaDescription: Intranet Explorer - Ja, das erscheint mir aktuell als wesentlich passenderen Namen für den Microsoft IE.
image: ''
ogTitle: Intranet Explorer
ogDescription: Ja, das erscheint mir aktuell als wesentlich passenderen Namen für den Microsoft IE. Wieso komme ich darauf? Ausgehend von einer laufenden Unterhaltung mit dem Eisbären ergab sich die Idee nahezu als...
layout: post
...
authorSlug: joki
canonicalUrl: https://jochen.kirstaetter.name/intranet-explorer/
imageUrl: ''
twitterImageUrl: ''
...
featureImage: ''
featured: false
publishedAt: 2005-10-12T00:00:00Z
updatedAt: 2018-04-02T08:39:03Z
excerpt: Ja, das erscheint mir aktuell als wesentlich passenderen Namen für den Microsoft IE. Wieso komme ich darauf? Ausgehend von einer laufenden Unterhaltung mit dem Eisbären ergab sich die Idee nahezu als...
twitterTitle: Intranet Explorer
twitterDescription: Ja, das erscheint mir aktuell als wesentlich passenderen Namen für den Microsoft IE. Wieso komme ich darauf? Ausgehend von einer laufenden Unterhaltung mit dem Eisbären ergab sich die Idee nahezu als...
twitterImage: 
facebookTitle: Intranet Explorer
facebookDescription: Ja, das erscheint mir aktuell als wesentlich passenderen Namen für den Microsoft IE. Wieso komme ich darauf? Ausgehend von einer laufenden Unterhaltung mit dem Eisbären ergab sich die Idee nahezu als...
facebookImage: ''
codeinjectionHead: 
codeinjectionFoot: 
---
...
*12.10.2005 14:39 Delfin@Work: Öhem... cool... Schon mal ins Infosystem geschaut. Ich hab' irgendwie den Rahmen bei der Combobox entsorgt...  
...
Also, gehen wir davon aus, dass wir in einer kontrollierten, gesicherten Arbeitsumgebung aktiv sein können. Und jetzt, kann ich mir auch wieder den IE als geeignetes Werkzeug zur Anwendung der webbasierten Software vorstellen. Daher auch die Idee für die Namensänderung **Intranet Explorer**.  
  
Zusätzlich müsste eine entsprechende Netzwerk-Kontrollinstanz sicherstellen, dass keine externen Requests (also dem bösen Internet) ausgehend vom IE mittels Proxies und Firewalls zugelassen wird. Hier sehe ich ein besonderes Tätigkeitsfeld für den Systemadministrator. 😎  
