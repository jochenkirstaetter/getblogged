...
status: published
type: post
description: Have you ever read a tutorial about something that you are new to, and really need to get into the subject quickly, just to discover that there is an essential piece of information missing? Yup...
tags:
- Community
- Personal
...
excerpt: Have you ever read a tutorial about something that you are new to, and really need to get into the subject quickly, just to discover that there is an essential piece of information missing? Yup...
twitterTitle: The Curse of the Magical Tutorial
twitterDescription: Have you ever read a tutorial about something that you are new to, and really need to get into the subject quickly, just to discover that there is an essential piece of information missing? Yup...
twitterImage: 
facebookTitle: The Curse of the Magical Tutorial
facebookDescription: Have you ever read a tutorial about something that you are new to, and really need to get into the subject quickly, just to discover that there is an essential piece of information missing? Yup...
facebookImage: ''
codeinjectionHead: 
codeinjectionFoot: 
...
The reader of a tutorial is not as familiar with the subject as you, the writer, might be, and this is something that should be taken into consideration before hitting that weird `Publish` button. As a reader, having to deal with an incomplete tutorial - or magical tutorial as I like to call them - is utterly frustrating for several reasons.
...
Additionally, I [learned something from John O'Nolan](https://blog.ghost.org/hemingway-mode/), the creator of the Ghost blogging platform:
...
<small>Cover image courtesy of Jason Leung</small>