...
status: published
type: post
description: It looks pretty simple when you see it in movies or watching a practitioner that dictates something into a recording device. Trying to write or better said to dictate an article the first time requires a lot more concentration than typing.
tags:
- Windows
keywords: Windows
...
excerpt: It looks pretty simple when you see it in movies or watching a practitioner that dictates something into a recording device. Trying to write or better said to dictate an article the first time requires a lot more concentration than typing.
twitterTitle: First steps using dictation in Windows 10
twitterDescription: It looks pretty simple when you see it in movies or watching a practitioner that dictates something into a recording device. Trying to write or better said to dictate an article the first time requires a lot more concentration than typing.
twitterImage: 
facebookTitle: First steps using dictation in Windows 10
facebookDescription: It looks pretty simple when you see it in movies or watching a practitioner that dictates something into a recording device. Trying to write or better said to dictate an article the first time requires a lot more concentration than typing.
facebookImage: ''
codeinjectionHead: 
codeinjectionFoot: 
