...
[https://jochen.kirstaetter.name/files/joki_DynamicLinkLibraries.zip](https://jochen.kirstaetter.name/dynamic-link-libraries-in-vfp-verwenden/files/joki_DynamicLinkLibraries.zip) (Slide und Code)  
