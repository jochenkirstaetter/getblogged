...
status: published
type: post
description: Our meetup this month is themed towards WordPress. Some say it is one of the best content management systems in the world... Well, have a look for yourself.
tags:
- Community
keywords: Community
...
excerpt: Having more sessions from our very own community members seems to be the right way to go.
twitterTitle: 'MSCC: WordPress - An Introduction'
twitterDescription: Having more sessions from our very own community members seems to be the right way to go.
twitterImage: 
facebookTitle: 'MSCC: WordPress - An Introduction'
facebookDescription: Having more sessions from our very own community members seems to be the right way to go.
facebookImage: ''
codeinjectionHead: 
codeinjectionFoot: 
...
And Rikesh also made all the code samples available on Github: [https://github.com/rrikesh/hello-wordpress-mscc](https://github.com/rrikesh/hello-wordpress-mscc)[](https://github.com/rrikesh/hello-wordpress-mscc "https://github.com/rrikesh/hello-wordpress-mscc")
