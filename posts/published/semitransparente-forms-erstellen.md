...
This.Parent.nYCoord = m.nYCoord - Objtoclient(This.Parent, OBJTOCLIENT\_TOP)  
EndProc
...
m.lnLeftMin = ObjToClient(This, OBJTOCLIENT\_LEFT)  
...
\*------------------------------------------------------------------  
Assert Inlist(Vartype(m.toForm), T\_OBJECT, T\_OPTIONAL)  
If Vartype(m.toForm) == T\_OBJECT  
This.oForm = m.toForm  
Endif
