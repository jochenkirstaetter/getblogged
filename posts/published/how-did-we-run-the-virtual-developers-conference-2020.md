...
image: content/images/2020/09/GerganaYoung.jpg
...
imageUrl: https://jochen.kirstaetter.name/content/images/2020/09/GerganaYoung.jpg
twitterImageUrl: https://jochen.kirstaetter.name/content/images/2020/09/GerganaYoung.jpg
authorImageUrl: https://jochen.kirstaetter.name/content/images/2018/10/JoKi_StAubin_100px.jpg
authorPageUrl: https://jochen.kirstaetter.name/author/joki/
tagName: ''
tagDescription: ''
featureImage: content/images/2020/09/GerganaYoung.jpg
featured: false
...
![Image courtesy of [Maarten Balliauw](https://blog.maartenballiauw.be/post/2020/04/02/streaming-a-community-event-on-youtube-sharing-the-technologies-and-learnings-from-virtual-azure-community-day.html)](../content/images/2020/09/image-27.png)
...
![Choose the Windows 10 image in the Azure Marketplace](../content/images/2020/09/image.png)

Choose the `Microsoft Windows 10` option, not the `Preview` one, and proceed.

![Choose Windows 10 Pro, latest build version](../content/images/2020/09/image-1.png)
...
![Pay attention to the selection of Region and Size of your VM](../content/images/2020/09/image-2.png)
...
![Large list of available VM sizes on Azure](../content/images/2020/09/image-4.png)

Optionally, add a filter to the list of available VM sizes specifying that you want GPU support.

![Ease your life using a filter on GPU enabled VM sizes](../content/images/2020/09/image-3.png)
...
![Note that to use more than 10 vCPUs you need to request an increase](../content/images/2020/09/image-5.png)
...
![Install the GPU extension](../content/images/2020/09/image-6.png)

There, click on **Select an extension to install** and choose the NVIDIA GPU Driver Extension on the next blade.

![NVIDIA to the rescue...](../content/images/2020/09/image-7.png)

Click on **Create** at the bottom of the page.

![The VM definitely reboots - even multiple times...](../content/images/2020/09/image-8.png)
...
![Extension is set for deployment](../content/images/2020/09/image-9.png)
...
![Summary of the VM parameters. Ready to deploy.](../content/images/2020/09/image-10.png)
...
![Microsoft Skype doesn't play nice if same account is used from multiple locations](https://lh3.googleusercontent.com/qYVgtkZfvIyld-hz35D6KBzRO3uj-WivPXyjgSFiA8Rw0oM-5DU6-uuXGsw-zj1f2tt4SlfUMHUjX_y5q-CCcCIxdKLcxvF_w_oHohAorwf2Kn9q9Gt-C1h26vNUZoMJyIMuIArU)
...
![Navigate to the Calling &gt; Advanced settings](../content/images/2020/09/image-13.png)
...
![Enable NDI usage and activate automatic answering of incoming calls on the VM](../content/images/2020/09/image-12.png)
...
![Configure your conference "room" in Skype already and add all peers](../content/images/2020/09/image-33.png)
...
![Check permission on macOS to grant Skype access to the camera...](https://lh6.googleusercontent.com/_FzuQ1n7PPeZ-QkonT4UYLydcEIGv4WaS4p-zmQHnwpxPISxQFJ8V_Is77ZiXDTolRoR2s82tKMyh-3C_I0JQq5N9wfwvIgqtA_ddZc6ra7SK2kqG7-Qqxqx6t0Itb1VwzmtryU9)![... and microphone on your machine](https://lh6.googleusercontent.com/9Agx20VrGCNxgPUhcakaWZCmK_Z4QoaoGdNBhHlGhDprM67zOH4mIVJ9aO1Z_zTacRvcmxJjgmGxo02EipkqiI3GVhyg3GH5EhPSUzvSn7kCWBgs93PR3Cr7VF95FbJyfIQ1dzGg)
...
![An early set of stages / scenes for the conference stream](../content/images/2020/09/image-14.png)
...
![Add your Skype accounts to OBS Studio](../content/images/2020/09/image-15.png)

Then give it a name under **Create new** and confirm the dialog with **OK**.

![Naming should be clear and intuitive for the OBS director](../content/images/2020/09/image-16.png)
...
![Choosing the source based on the Skype ID](../content/images/2020/09/image-17.png)
...
![Adding the shared screen feed of Skype](../content/images/2020/09/image-18.png)

And then the `Skype - Active speaker` to round up all sources needed.

![Adding a generic audio feed of Skype (never mute this one)](../content/images/2020/09/image-19.png)

The list of sources for one of our stages called `Split - 3` that shows two hosts and one speaker looks similar to this.

![Proper alignment and positioning of all sources within a single scene](../content/images/2020/09/image-20.png)
...
![Sample setup to display one speaker (left) and two hosts (right)](../content/images/2020/09/image-21.png)
...
![Adjust each Skype source to avoid automatic resizing](../content/images/2020/09/image-23.png)
...
![Mute all audio sources of Skype except your Active speaker to avoid echoes](../content/images/2020/09/image-22.png)
...
![Check and adjust the audio level and monitor the meter](../content/images/2020/09/image-29.png)
...
![Get the stream key from YouTube studio](../content/images/2020/09/image-25.png)
...
![Apply the stream key in OBS Studio](../content/images/2020/09/image-26.png)
...
![Enable remote audio playback for your VM](../content/images/2020/09/image-30.png)
...
![Mute the VM's audio to avoid local echoes in Skype](../content/images/2020/09/image-31.png)
...
![Adjust your screen resolution and colour depth depending on your bandwidth](../content/images/2020/09/image-32.png)
