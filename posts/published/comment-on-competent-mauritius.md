...
status: published
type: post
description: Response to an article on noulakaz.net about the level of competence in Mauritius.
tags:
- General
keywords: General
...
excerpt: Sadly, my comment on the original address is not available. Might have been due to technical issues, don't know.
twitterTitle: Comment on 'Competent Mauritius'
twitterDescription: Sadly, my comment on the original address is not available. Might have been due to technical issues, don't know.
twitterImage: 
facebookTitle: Comment on 'Competent Mauritius'
facebookDescription: Sadly, my comment on the original address is not available. Might have been due to technical issues, don't know.
facebookImage: ''
codeinjectionHead: 
codeinjectionFoot: 
